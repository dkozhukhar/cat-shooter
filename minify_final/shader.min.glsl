...
//xyz=pos,w=radius(sign:>0 shard,<0 heal)
...
//xyz=half-size,w=activeFlag(>0=активні/“сексуальні”)
...
//неактивні — холодно-фіолетові
vec3 colOn=vec3(1.60,0.35,0.90);
//активні — яскраво-магентні
